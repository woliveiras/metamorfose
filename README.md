...
| Strategy    | Blueprint      | Develop     | Build         | Deploy     |
|-------------|----------------|-------------|---------------|------------|
| Research    | Sitemap        | Scaffolding | Lint          | Test       |
| Observe     | Wireframe      | Libraries   | Concatenate   | Optimize   |
| Understand  | Prototype      | Templates   | Minify        | **LAUNCH** |
| Analyze     | Style Guide    | Frameworks  | Compile       |            |
...
Based on: [@vitorbritto, workflow-guide](https://github.com/vitorbritto/workflow-guide)
